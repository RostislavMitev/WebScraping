...
string input = @"<div class=""item"" rating = ""3"" data-pdid=""5426""><figure><a
...
//storing every product that we've collected in a list
List<ProductInfo> products = HtmlParser.InformationExtractor(input);

//walking through every product to show the output
foreach (ProductInfo product in products)
{
    Console.WriteLine($"{{\n\"productName\": \"{product.ProductName}\",\n\"price\": \"{product.Price}\",\n\"rating\": \"{product.Rating:f1}\"\n}},");
}